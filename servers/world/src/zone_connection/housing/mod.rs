...
use kawari::{
    common::{
        ContainerType, HouseId, HouseUnit, HousingFlag, ITEM_CONDITION_MAX, ItemOperationKind,
        LandData, Position, internal_housing_row,
    },
    ipc::zone::{
...
const MINIMAL_INTERIOR_LIGHT: u32 = 65848; // Flat Ceiling Lamp, Item.AdditionalData
...
fn housing_indoor_init_needs_resolution(active_estate: Option<&ActiveHousingEstate>) -> bool {
...
fn owned_housing_land_data(estates: &[HousingEstate]) -> ([LandData; 5], LandData) {
...
fn build_apartment_list_entries(
...
fn estate_land_data(estate: &HousingEstate) -> LandData {
    LandData {
...
fn housing_occupied_land_info_from_estate(estate: &HousingEstate) -> HousingOccupiedLandInfo {
...
fn housing_vacant_land_info() -> HousingVacantLandInfo {
    let mut unk4 = [0; 20];
    unk4[12..].fill(0xFF);
...
fn housing_estate_greeting_from_estate(estate: &HousingEstate) -> HousingEstateGreeting {
...
fn build_house_list_houses(estates: &[HousingEstate]) -> [House; 30] {
...
struct HouseExteriorJson {
    ...
    door_id: Option<u16>,
    #[serde(skip_serializing_if = "Option::is_none")]
    roof_fixture_id: Option<u16>,
    #[serde(skip_serializing_if = "Option::is_none")]
    wall_fixture_id: Option<u16>,
    #[serde(skip_serializing_if = "Option::is_none")]
    above_door_banner_id: Option<u16>,
    #[serde(skip_serializing_if = "Option::is_none")]
    fence_id: Option<u16>,
    #[serde(skip_serializing_if = "Option::is_none")]
    colors: Option<HouseExteriorColorsJson>,
}

#[derive(Debug, Clone, Serialize, Deserialize, Default)]
struct HouseExteriorColorsJson {
    #[serde(skip_serializing_if = "Option::is_none")]
    roof: Option<u8>,
    #[serde(skip_serializing_if = "Option::is_none")]
    walls: Option<u8>,
    ...
    door: Option<u8>,
    #[serde(skip_serializing_if = "Option::is_none")]
    roof_fixture: Option<u8>,
    #[serde(skip_serializing_if = "Option::is_none")]
    wall_fixture: Option<u8>,
    #[serde(skip_serializing_if = "Option::is_none")]
    above_door_banner: Option<u8>,
    #[serde(skip_serializing_if = "Option::is_none")]
    fence: Option<u8>,
}

#[derive(Debug, Clone, Serialize, Deserialize, Default)]
struct HouseInteriorJson {
    #[serde(skip_serializing_if = "Option::is_none")]
    renovation_row_id: Option<u16>,
    #[serde(skip_serializing_if = "Option::is_none")]
    window_style: Option<u16>,
    #[serde(skip_serializing_if = "Option::is_none")]
    door_style: Option<u16>,
    #[serde(skip_serializing_if = "Option::is_none")]
    door_stain: Option<u16>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ground_walls: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ground_floor: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    ground_chandelier: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    top_walls: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    top_floor: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    top_chandelier: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    cellar_walls: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    cellar_floor: Option<u32>,
    #[serde(skip_serializing_if = "Option::is_none")]
    cellar_chandelier: Option<u32>,
}
...
fn housing_furniture_object_from_row(
    row: &HousingFurniture,
    indoors: bool,
    plot_index: u8,
...
fn housing_interior_details(light_level: u8) -> HousingInteriorDetails {
...
fn housing_interior_details_from_json(
    json: &str,
    light_level: u8,
    is_apartment: bool,
...
fn housing_interior_renovation_row_id_from_json(json: &str) -> Option<u16> {
...
mod tests {
    ...
    use kawari::{
        common::HousingFlag,
        ipc::zone::{
            AvailabilityType, HouseStatus, HousingFlags, PlotSize, PurchaseType, TenantType,
        },
    };
