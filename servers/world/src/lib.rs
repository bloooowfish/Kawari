...
mod database;
pub use database::{
    Content, DEFAULT_LOCAL_HOUSING_DIVISION, DEFAULT_LOCAL_HOUSING_LAND_FLAGS,
    DEFAULT_LOCAL_HOUSING_PLOT_INDEX, DEFAULT_LOCAL_HOUSING_PLOT_SIZE,
    DEFAULT_LOCAL_HOUSING_TERRITORY_TYPE_ID, DEFAULT_LOCAL_HOUSING_WARD_INDEX, HousingEstate,
    HousingEstateSpec, HousingFurniture, MAX_APARTMENT_ROOM_NUMBER, Unlock, WorldDatabase,
};
...
pub use common::{
    ...
    HousingFurnitureObjectScope, HousingPlotLocation, MessageInfo, ServerHandle, ToServer,
};
